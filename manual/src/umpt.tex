...
\]
В случае $\sigma^2_0 < \sigma^2_1$ формула останется прежней за исключением замены $\chi^2_{n,\alpha}$ на $\chi^2_{n,1-\alpha}$ (подумайте, почему).
\end{example}
...
\begin{itemize}
    ...
    $$R = \left\{\mathbf{x}\colon -\sum x_i \ge -y_{\alpha}\right\} = \left\{\mathbf{x}\colon \sum x_i \le y_{\alpha}\right\},$$
