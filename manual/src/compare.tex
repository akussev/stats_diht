...
Ясно, что это $\sigma$-конечная мера и она равна количеству попадающих в данное множество целочисленных точек, откуда и пошло название. Несложно также понять, как считается интеграл произвольной измеримой функции $f$ по этой мере:
\[
